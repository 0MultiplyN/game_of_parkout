...
def animation( select_role ):
    

    # 指定放大後的寬度和高度
    new_width = 1.5 * POBJ.get_width()
    new_height = 1.5 * POBJ.get_height()

    # 使用 pygame.transform.scale() 函式放大圖片
    scaled_image = pygame.transform.scale(POBJ, (new_width, new_height))
    SCREEN.fill((255, 255, 255)) 
    # 繪製藍色矩形
    pygame.draw.rect(SCREEN, (175 , 238 ,  238) , (0, 0, SCREEN_WIDTH , SCREEN_HEIGHT // 2 ))

    # 繪製白色矩形
    pygame.draw.rect(SCREEN, (255, 255, 255), (SCREEN_WIDTH , 0, SCREEN_WIDTH, SCREEN_HEIGHT // 2 ))

    font = pygame.font.Font('freesansbold.ttf', 50)
    text = font.render("Loading o o o o o", True, (20, 10, 10))
    textRect = text.get_rect()
    textRect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 80 )
    SCREEN.blit(text, textRect)
    SCREEN.blit(scaled_image, (SCREEN_WIDTH // 2 - 370 , SCREEN_HEIGHT // 2 + 60  ))
    pygame.display.update()
    ...
    font = pygame.font.Font('freesansbold.ttf', 50)
    text = font.render("Loading o o o", True, (20, 10, 10))
    textRect = text.get_rect()
    textRect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 80 )
    SCREEN.blit(text, textRect)
    SCREEN.blit(scaled_image, (SCREEN_WIDTH // 2 - 35 , SCREEN_HEIGHT // 2 + 60  ))
    pygame.display.update()
    pygame.time.delay(1000)
    SCREEN.fill((255, 255, 255)) 
    # 繪製藍色矩形
    ...
    font = pygame.font.Font('freesansbold.ttf', 50)
    text = font.render("Loading", True, (20, 10, 10))
    textRect = text.get_rect()
    textRect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 80 )
    SCREEN.blit(text, textRect)
    SCREEN.blit(scaled_image, (SCREEN_WIDTH // 2 + 350  , SCREEN_HEIGHT // 2 + 60  ))
    pygame.display.update()
    pygame.time.delay(1000)
       
    # font = pygame.font.Font('freesansbold.ttf', 50)
    # text = font.render("START ! ! !", True, (20, 10, 10))
    # textRect = text.get_rect()
    # textRect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 20)
    # SCREEN.blit(text, textRect)
    # SCREEN.blit(POBJ, (SCREEN_WIDTH // 2 - 50, SCREEN_HEIGHT // 2 - 200))
    # SCREEN.blit(POBJ, (SCREEN_WIDTH // 2 + 60, SCREEN_HEIGHT // 2 - 200))
    # pygame.display.update()
    # pygame.time.delay(1000)

def main(select_role):
    animation( select_role )
    pygame.event.get()
    pygame.event.clear()
